...
parser.add_argument('--grow_batch_size', type=int, default=1024, help='batch size')
parser.add_argument('--learning_rate', type=float, default=0.5, help='init learning rate')
parser.add_argument('--learning_rate_middle', type=float, default=0.8, help='min learning rate')
parser.add_argument('--learning_rate_min', type=float, default=0.001, help='min learning rate')
parser.add_argument('--learning_rate_stable', type=float, default=0.1, help='min learning rate')
...
parser.add_argument('--init', type=int, default=20, help='num of init epochs')
